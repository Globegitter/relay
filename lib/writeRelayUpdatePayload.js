...
function addRangeElement(writer, operation, config, parentID, newElementID, newElementData) {
  ...
  var path = require('./RelayQueryPath').createForID(newElementID, config.listName);
  require('fbjs/lib/invariant')(path, 'writeRelayUpdatePayload(): Expected a path for connection record, `%s`.', parentID);
